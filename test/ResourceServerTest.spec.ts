...
import { ResourceServer, ResourceServerI } from '../dist';
...
describe('Resource Server Test', () => {
    ...
    it('should validate authenticated request', () => {
